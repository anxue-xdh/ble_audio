...
> [2025-04-12 15:30:34.199]
> TX：music task query
> [2025-04-12 15:30:34.313]
> RX：[DEBUG] music task query
> Wav_Task_Handle Task is 4
>
> [2025-04-12 15:30:58.905]
> RX：Wav_Task_Handle Task is 4
> create Wav_Task_Handle
> 0:/BaJiaoNightRain_R.wav
> f_res:4
> ！！打开文件失败。

如果中途因为读取文件失败，强制关闭了播放任务，会导致再次读取文件时，无法找到文件，导致无法正常播放
