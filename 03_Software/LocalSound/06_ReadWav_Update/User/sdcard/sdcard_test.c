...
void SD_Test(void)
{
  ...
  {    
    Uart1_SendData("SD卡初始化失败，请确保SD卡已正确接入开发板，或换一张SD卡测试！\n");
  }
  else
  {
    Uart1_SendData("SD卡初始化成功！\n");		 
  }
...
{  
  ...
  {
    Uart1_SendData("Single block 测试成功！\n");

  }
  else
  {
    Uart1_SendData("Single block 测试失败，请确保SD卡正确接入开发板，或换一张SD卡测试！\n");
...
{  
  ...
  {
    Uart1_SendData("Multi block 测试成功！");

  }
  else
  {
    Uart1_SendData("Multi block 测试失败，请确保SD卡正确接入开发板，或换一张SD卡测试！");
  }
}
