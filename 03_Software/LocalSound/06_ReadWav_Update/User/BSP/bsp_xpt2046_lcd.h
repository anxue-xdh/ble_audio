...
#define XPT2046_CS_ENABLE() XPT2046_SPI_CS_PORT->BSRR = XPT2046_SPI_CS_PIN
#define XPT2046_CS_DISABLE() XPT2046_SPI_CS_PORT->BRR = XPT2046_SPI_CS_PIN

#define XPT2046_CLK_HIGH() XPT2046_SPI_CLK_PORT->BSRR = XPT2046_SPI_CLK_PIN
#define XPT2046_CLK_LOW() XPT2046_SPI_CLK_PORT->BRR = XPT2046_SPI_CLK_PIN

#define XPT2046_MOSI_1() XPT2046_SPI_MOSI_PORT->BSRR = XPT2046_SPI_MOSI_PIN
#define XPT2046_MOSI_0() XPT2046_SPI_MOSI_PORT->BRR = XPT2046_SPI_MOSI_PIN
